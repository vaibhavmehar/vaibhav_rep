        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="http://nucigent.in/clients/hibbsr/captain/order-status.jsp#">Welcome Admin - Add Item Type</a>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width">
										...
										<div class="foot-title" style="margin-left:30px" id="starter">
											 ...
											 <input type="hidden" name="MenuOrder" value="4">
											<input id="ItemType" class="h180" style="margin-left:30px;width:500px" type="text" name="ItemType">
										    <input type="submit" value="Add New Item Type" style="font-size: 14px !important;background-color:#3498db;color: #fff;font-family: 'Open Sans', sans-serif !important;cursor: pointer;"class="button" onclick="AddItem()" >
...
function AddItem()
{
	...
	if(document.getElementById("ItemType").value.length!=0)
	{
