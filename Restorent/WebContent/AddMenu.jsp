                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Add New Menu Items</p>
                            </div>
										...
										<div class="foot-title" style="margin-left:30px" id="starter">
										   ...
										   <select id="ItemType" class="select-member" class="h180" style="padding:10px;margin-left:30px;width:500px;font-size: 14px;font-family: 'Open Sans', sans-serif !important">
											...
											<% List<String> l = DAO.Resto_getData("SELECT ITEM_TYPE FROM RESTO_ITEM_TYPE", 1);  
                            ...
                            <div class="content table-responsive table-full-width">
										...
										<div class="foot-title" style="margin-left:30px" id="starter">
											...
											<input id="Itemname" class="h180" style="margin-left:30px;width:500px;border:1px solid #ccc" type="text">
							...
							<div class="content table-responsive table-full-width">
							  ...
							  <div class="content table-responsive table-full-width">
                                   <input type="submit" value="Add New Menu Items" style="margin-left:30px;font-size: 14px !important;background-color:#3498db;color: #fff;font-family: 'Open Sans', sans-serif !important;cursor: pointer;"class="button" onclick="insertValue()">                                  
								<input type="submit" value="Click Here to Update or Delete existing Menu Items" style="margin-left:30px;font-size: 14px !important;background-color:#3498db;color: #fff;font-family: 'Open Sans', sans-serif !important;cursor: pointer;"class="button" onclick="window.location = 'UpdateMenu.jsp'">
                                        </div>
...
{
	if(document.getElementById("Itemname").value.length!=0 && document.getElementById("ItemType").value!="Select Item Type" && document.getElementById("Desc1").value.length!=0 && document.getElementById("price").value.length!=0)
	{
		window.location = "AUser?Itemname=" + encodeValue(document.getElementById("Itemname").value)+"&ItemType="+encodeValue(document.getElementById("ItemType").value)+"&Desc="+encodeValue(document.getElementById("Desc1").value)+"&Price="+document.getElementById("price").value+"&MenuOrder=8";
	}
	else
	{
